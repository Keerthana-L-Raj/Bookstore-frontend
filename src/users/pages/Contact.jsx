...
function Contact() {
  ...
  return (
    <div>
       <Header />
      <div>
        <h1 className='text-4xl text-center m-4 mt-4 pt-18' >Contact us</h1>
      </div>
      ...
      <div className='flex gap-70 m-7 ps-35'>
        <div>
           <h1 className='text-2xl'><FaLocationDot /> <span className='text-xl'>123,Main Street,Kochi</span></h1>
        </div>
        
        <div>
           <h1 className='text-2xl'><FaPhoneAlt /> <span className='text-xl'>+91 9876543210</span></h1>
        </div> 

        <div>
           <h1 className='text-2xl'><MdEmail /> <span className='text-xl'>readcoats@gmail.com</span></h1>
        </div>
